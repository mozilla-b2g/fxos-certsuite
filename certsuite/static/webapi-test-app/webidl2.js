...
(function () {
    ...
    var parse = function (tokens, opt) {
        ...
        var simple_extended_attr = function (store) {
            ...
            if (eq) {
                all_ws();
                // Mozilla webidl contains quoted identifiers as extended
                // attributes e.g. "IsChromeOrXBL" which we special case
                // here.
                var tok = tokens[0].value;
        ...
        var attribute = function (store) {
            ...
            // We seem to have sequence types
        ...
        var interface_ = function (isPartial, store) {
            ...
            all_ws();
            if (!consume(OTHER, "{")) {
                // Mozilla idl contains bodyless interfaces e.g. "interface StyleSheetList;"
